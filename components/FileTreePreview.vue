...
const fileTree = [
  { name: '.github', type: 'folder', level: 0, expanded: true },
  { name: 'workflows', type: 'folder', level: 1, expanded: true },
  { name: 'deploy.yml', type: 'file', level: 2, modified: false },
  { name: 'test.yml', type: 'file', level: 2, modified: false },
  { name: 'components', type: 'folder', level: 0, expanded: true },
  { name: 'CodePreview.vue', type: 'file', level: 1, modified: true },
  { name: 'ColorControls.vue', type: 'file', level: 1, modified: true },
  { name: 'NvimPreview.vue', type: 'file', level: 1, modified: false },
  { name: 'ShellPreview.vue', type: 'file', level: 1, modified: true, untracked: true },
  { name: 'TmuxPreview.vue', type: 'file', level: 1, modified: false },
  { name: 'composables', type: 'folder', level: 0, expanded: true },
  { name: 'useTheme.ts', type: 'file', level: 1, modified: true },
  { name: 'pages', type: 'folder', level: 0, expanded: true },
  { name: 'index.vue', type: 'file', level: 1, modified: true },
  { name: 'utils', type: 'folder', level: 0, expanded: true },
  { name: 'ghostty.ts', type: 'file', level: 1, modified: false },
  { name: 'iterm.ts', type: 'file', level: 1, modified: true, untracked: true },
  { name: 'neovim.ts', type: 'file', level: 1, modified: false },
  { name: 'tmux.ts', type: 'file', level: 1, modified: false },
  { name: '.gitignore', type: 'file', level: 0, modified: false },
  { name: 'nuxt.config.ts', type: 'file', level: 0, modified: false },
  { name: 'package.json', type: 'file', level: 0, modified: true },
  { name: 'README.md', type: 'file', level: 0, modified: false },
