    ...
    <main class="preview-right">
      ...
      <div class="swatches-float">
        ...
        <div class="swatches">
          <div
            class="swatch"
            :style="{ background: colors.base, color: getTextColor(colors.base) }"
          >
            <span>base</span>
          ...
          <div
            ...
            :class="{ highlighted: highlightedColor === 'error' }"
            :style="{ background: colors.error, color: getTextColor(colors.error) }"
          >
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.error, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.error, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.error, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.error, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.error, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('error', 'AA')"
            ...
            <div class="swatch-tools">
              <button
                @click="state.errorLinked = !state.errorLinked"
                class="tool-btn"
                :class="{ active: state.errorLinked }"
                :title="state.errorLinked ? 'unlink from global offset' : 'link to global offset'"
              >
                {{ state.errorLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('error')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('error', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.errorLinked
                  ? (state.hueOffset * state.errorMultiplier + state.errorOffset).toFixed(0)
                  : state.errorOffset
              }}° · L{{ state.errorLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'warning' }"
            :style="{ background: colors.warning, color: getTextColor(colors.warning) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.warning, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.warning, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.warning, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.warning, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.warning, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('warning', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.warningLinked = !state.warningLinked"
                class="tool-btn"
                :class="{ active: state.warningLinked }"
                :title="state.warningLinked ? 'unlink from global offset' : 'link to global offset'"
              >
                {{ state.warningLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('warning')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('warning', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.warningLinked
                  ? (state.hueOffset * state.warningMultiplier + state.warningOffset).toFixed(0)
                  : state.warningOffset
              }}° · L{{ state.warningLightness }}
            </div>
            <input
          ...
          <div
            class="swatch"
            :style="{ background: colors.hint, color: getTextColor(colors.hint) }"
          >
            <span>hint</span>
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'keyword' }"
            :style="{ background: colors.keyword, color: getTextColor(colors.keyword) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.keyword, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.keyword, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.keyword, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.keyword, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.keyword, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('keyword', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.keywordLinked = !state.keywordLinked"
                class="tool-btn"
                :class="{ active: state.keywordLinked }"
                :title="state.keywordLinked ? 'unlink from global offset' : 'link to global offset'"
              >
                {{ state.keywordLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('keyword')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('keyword', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.keywordLinked
                  ? (state.hueOffset * state.keywordMultiplier + state.keywordOffset).toFixed(0)
                  : state.keywordOffset
              }}° · L{{ state.keywordLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'string' }"
            :style="{ background: colors.string, color: getTextColor(colors.string) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.string, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.string, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.string, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.string, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.string, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('string', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.stringLinked = !state.stringLinked"
                class="tool-btn"
                :class="{ active: state.stringLinked }"
                :title="state.stringLinked ? 'unlink from global offset' : 'link to global offset'"
              >
                {{ state.stringLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('string')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('string', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.stringLinked
                  ? (state.hueOffset * state.stringMultiplier + state.stringOffset).toFixed(0)
                  : state.stringOffset
              }}° · L{{ state.stringLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'number' }"
            :style="{ background: colors.number, color: getTextColor(colors.number) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.number, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.number, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.number, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.number, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.number, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('number', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.numberLinked = !state.numberLinked"
                class="tool-btn"
                :class="{ active: state.numberLinked }"
                :title="state.numberLinked ? 'unlink from global offset' : 'link to global offset'"
              >
                {{ state.numberLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('number')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('number', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.numberLinked
                  ? (state.hueOffset * state.numberMultiplier + state.numberOffset).toFixed(0)
                  : state.numberOffset
              }}° · L{{ state.numberLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'function' }"
            :style="{ background: colors.function, color: getTextColor(colors.function) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.function, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.function, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.function, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.function, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.function, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('function', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.functionLinked = !state.functionLinked"
                class="tool-btn"
                :class="{ active: state.functionLinked }"
                :title="
                  state.functionLinked ? 'unlink from global offset' : 'link to global offset'
                "
              >
                {{ state.functionLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('function')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('function', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.functionLinked
                  ? (state.hueOffset * state.functionMultiplier + state.functionOffset).toFixed(0)
                  : state.functionOffset
              }}° · L{{ state.functionLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'constant' }"
            :style="{ background: colors.constant, color: getTextColor(colors.constant) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.constant, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.constant, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.constant, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.constant, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.constant, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('constant', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.constantLinked = !state.constantLinked"
                class="tool-btn"
                :class="{ active: state.constantLinked }"
                :title="
                  state.constantLinked ? 'unlink from global offset' : 'link to global offset'
                "
              >
                {{ state.constantLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('constant')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('constant', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.constantLinked
                  ? (state.hueOffset * state.constantMultiplier + state.constantOffset).toFixed(0)
                  : state.constantOffset
              }}° · L{{ state.constantLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'type' }"
            :style="{ background: colors.type, color: getTextColor(colors.type) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.type, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.type, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.type, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.type, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.type, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('type', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.typeLinked = !state.typeLinked"
                class="tool-btn"
                :class="{ active: state.typeLinked }"
                :title="state.typeLinked ? 'unlink from global offset' : 'link to global offset'"
              >
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('type', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.typeLinked
                  ? (state.hueOffset * state.typeMultiplier + state.typeOffset).toFixed(0)
                  : state.typeOffset
              }}° · L{{ state.typeLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'variable' }"
            :style="{ background: colors.variable, color: getTextColor(colors.variable) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.variable, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.variable, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.variable, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.variable, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.variable, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('variable', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.variableLinked = !state.variableLinked"
                class="tool-btn"
                :class="{ active: state.variableLinked }"
                :title="
                  state.variableLinked ? 'unlink from global offset' : 'link to global offset'
                "
              >
                {{ state.variableLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('variable')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('variable', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.variableLinked
                  ? (state.hueOffset * state.variableMultiplier + state.variableOffset).toFixed(0)
                  : state.variableOffset
              }}° · L{{ state.variableLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'operator' }"
            :style="{ background: colors.operator, color: getTextColor(colors.operator) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.operator, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.operator, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.operator, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.operator, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.operator, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('operator', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.operatorLinked = !state.operatorLinked"
                class="tool-btn"
                :class="{ active: state.operatorLinked }"
                :title="
                  state.operatorLinked ? 'unlink from global offset' : 'link to global offset'
                "
              >
                {{ state.operatorLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('operator')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('operator', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.operatorLinked
                  ? (state.hueOffset * state.operatorMultiplier + state.operatorOffset).toFixed(0)
                  : state.operatorOffset
              }}° · L{{ state.operatorLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'builtin' }"
            :style="{ background: colors.builtin, color: getTextColor(colors.builtin) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.builtin, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.builtin, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.builtin, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.builtin, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.builtin, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('builtin', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.builtinLinked = !state.builtinLinked"
                class="tool-btn"
                :class="{ active: state.builtinLinked }"
                :title="state.builtinLinked ? 'unlink from global offset' : 'link to global offset'"
              >
                {{ state.builtinLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('builtin')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('builtin', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.builtinLinked
                  ? (state.hueOffset * state.builtinMultiplier + state.builtinOffset).toFixed(0)
                  : state.builtinOffset
              }}° · L{{ state.builtinLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'parameter' }"
            :style="{ background: colors.parameter, color: getTextColor(colors.parameter) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.parameter, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.parameter, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.parameter, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.parameter, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.parameter, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('parameter', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
              ...
              <button
                @click="lockToWCAG('parameter', 'AAA')"
                class="lock-btn lock-aaa"
                title="lock to WCAG AAA (7:1)"
              >
                Lock AAA
            ...
            <div class="swatch-tools">
              <button
                @click="state.parameterLinked = !state.parameterLinked"
                class="tool-btn"
                :class="{ active: state.parameterLinked }"
                :title="
                  state.parameterLinked ? 'unlink from global offset' : 'link to global offset'
                "
              >
                {{ state.parameterLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('parameter')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('parameter', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.parameterLinked
                  ? (state.hueOffset * state.parameterMultiplier + state.parameterOffset).toFixed(0)
                  : state.parameterOffset
              }}° · L{{ state.parameterLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'property' }"
            :style="{ background: colors.property, color: getTextColor(colors.property) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.property, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.property, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.property, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.property, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.property, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('property', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.propertyLinked = !state.propertyLinked"
                class="tool-btn"
                :class="{ active: state.propertyLinked }"
                :title="
                  state.propertyLinked ? 'unlink from global offset' : 'link to global offset'
                "
              >
                {{ state.propertyLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('property')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('property', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.propertyLinked
                  ? (state.hueOffset * state.propertyMultiplier + state.propertyOffset).toFixed(0)
                  : state.propertyOffset
              }}° · L{{ state.propertyLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'namespace' }"
            :style="{ background: colors.namespace, color: getTextColor(colors.namespace) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.namespace, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.namespace, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.namespace, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.namespace, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.namespace, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('namespace', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
              ...
              <button
                @click="lockToWCAG('namespace', 'AAA')"
                class="lock-btn lock-aaa"
                title="lock to WCAG AAA (7:1)"
              >
                Lock AAA
            ...
            <div class="swatch-tools">
              <button
                @click="state.namespaceLinked = !state.namespaceLinked"
                class="tool-btn"
                :class="{ active: state.namespaceLinked }"
                :title="
                  state.namespaceLinked ? 'unlink from global offset' : 'link to global offset'
                "
              >
                {{ state.namespaceLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('namespace')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('namespace', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.namespaceLinked
                  ? (state.hueOffset * state.namespaceMultiplier + state.namespaceOffset).toFixed(0)
                  : state.namespaceOffset
              }}° · L{{ state.namespaceLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'macro' }"
            :style="{ background: colors.macro, color: getTextColor(colors.macro) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.macro, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.macro, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.macro, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.macro, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.macro, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('macro', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.macroLinked = !state.macroLinked"
                class="tool-btn"
                :class="{ active: state.macroLinked }"
                :title="state.macroLinked ? 'unlink from global offset' : 'link to global offset'"
              >
                {{ state.macroLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('macro')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('macro', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.macroLinked
                  ? (state.hueOffset * state.macroMultiplier + state.macroOffset).toFixed(0)
                  : state.macroOffset
              }}° · L{{ state.macroLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'tag' }"
            :style="{ background: colors.tag, color: getTextColor(colors.tag) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.tag, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.tag, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.tag, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.tag, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.tag, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('tag', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.tagLinked = !state.tagLinked"
                class="tool-btn"
                :class="{ active: state.tagLinked }"
                :title="state.tagLinked ? 'unlink from global offset' : 'link to global offset'"
              >
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('tag', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.tagLinked
                  ? (state.hueOffset * state.tagMultiplier + state.tagOffset).toFixed(0)
                  : state.tagOffset
              }}° · L{{ state.tagLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'punctuation' }"
            :style="{ background: colors.punctuation, color: getTextColor(colors.punctuation) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.punctuation, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.punctuation, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.punctuation, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.punctuation, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.punctuation, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('punctuation', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
              ...
              <button
                @click="lockToWCAG('punctuation', 'AAA')"
                class="lock-btn lock-aaa"
                title="lock to WCAG AAA (7:1)"
              >
                Lock AAA
            ...
            <div class="swatch-tools">
              <button
                @click="state.punctuationLinked = !state.punctuationLinked"
                class="tool-btn"
                :class="{ active: state.punctuationLinked }"
                :title="
                  state.punctuationLinked ? 'unlink from global offset' : 'link to global offset'
                "
              >
                {{ state.punctuationLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('punctuation')" class="tool-btn" title="randomize">
                RAND
              </button>
              <button @click="resetColor('punctuation')" class="tool-btn" title="reset">
                RESET
              </button>
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('punctuation', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.punctuationLinked
                  ? (
                      state.hueOffset * state.punctuationMultiplier +
                      state.punctuationOffset
                    ).toFixed(0)
                  : state.punctuationOffset
              }}° · L{{ state.punctuationLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'heading' }"
            :style="{ background: colors.heading, color: getTextColor(colors.heading) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.heading, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.heading, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.heading, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.heading, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.heading, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('heading', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.headingLinked = !state.headingLinked"
                class="tool-btn"
                :class="{ active: state.headingLinked }"
                :title="state.headingLinked ? 'unlink from global offset' : 'link to global offset'"
              >
                {{ state.headingLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('heading')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('heading', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.headingLinked
                  ? (state.hueOffset * state.headingMultiplier + state.headingOffset).toFixed(0)
                  : state.headingOffset
              }}° · L{{ state.headingLightness }}
            </div>
            <input
          ...
          <div
            class="swatch editable"
            :class="{ highlighted: highlightedColor === 'comment' }"
            :style="{ background: colors.comment, color: getTextColor(colors.comment) }"
          >
            <div class="swatch-header">
            ...
            <div
              class="contrast-info"
              :title="`Contrast ratio: ${getContrastRatio(colors.comment, colors.bg).toFixed(2)}:1 (WCAG ${getContrastLevel(getContrastRatio(colors.comment, colors.bg))})`"
            >
              <span class="contrast-icon">{{
                getContrastIcon(getContrastRatio(colors.comment, colors.bg))
              }}</span>
              <span class="contrast-ratio"
                >{{ getContrastRatio(colors.comment, colors.bg).toFixed(1) }}:1</span
              >
              <span class="contrast-level">{{
                getContrastLevel(getContrastRatio(colors.comment, colors.bg))
              }}</span>
            </div>
            <div class="wcag-locks">
              <button
                @click="lockToWCAG('comment', 'AA')"
                class="lock-btn lock-aa"
                title="lock to WCAG AA (4.5:1)"
              >
                Lock AA
            ...
            <div class="swatch-tools">
              <button
                @click="state.commentLinked = !state.commentLinked"
                class="tool-btn"
                :class="{ active: state.commentLinked }"
                :title="state.commentLinked ? 'unlink from global offset' : 'link to global offset'"
              >
                {{ state.commentLinked ? 'LINK' : 'UNLNK' }}
              </button>
              <button @click="shuffleColor('comment')" class="tool-btn" title="randomize">
                RAND
              </button>
              ...
              <select
                @change="
                  (e) => {
                    const el = e.target as HTMLSelectElement
                    if (el.value) {
                      applyColorMath('comment', el.value as any)
                      el.value = ''
                    }
                  }
                "
            ...
            <div class="value-display">
              {{
                state.commentLinked
                  ? (state.hueOffset * state.commentMultiplier + state.commentOffset).toFixed(0)
                  : state.commentOffset
              }}° · L{{ state.commentLightness }}
            </div>
            <input
          ...
          <div
            class="swatch"
            :style="{ background: colors.bg, border: '1px solid ' + colors.comment }"
          >
      ...
      <div class="configs">
        <div
          ...
          :style="{ background: darkColors.bg, borderColor: darkColors.comment }"
        >
          <div
            class="config-header"
            :style="{ color: darkColors.comment, borderBottomColor: darkColors.comment }"
          >
            {{ exportFormats[0] || 'ghostty' }} - theme-lab-dark{{
              getFileExtension(exportFormats[0] || 'ghostty')
            }}
            <span
              v-if="exportFormats.length > 1"
              :style="{ fontSize: '7px', opacity: 0.6, marginLeft: '4px' }"
            >
        ...
        <div
          class="config-preview"
          :style="{ background: lightColors.bg, borderColor: lightColors.comment }"
        >
          <div
            class="config-header"
            :style="{ color: lightColors.comment, borderBottomColor: lightColors.comment }"
          >
            {{ exportFormats[0] || 'ghostty' }} - theme-lab-light{{
              getFileExtension(exportFormats[0] || 'ghostty')
            }}
            <span
              v-if="exportFormats.length > 1"
